...
in {
  options.my.features.hyprland.enable = mkEnableOption "Enable Hyprland compositor (Wayland) and related integrations";
  config = mkIf cfg.enable {
    ...
    environment.systemPackages = [ pkgs.dconf pkgs.gnome-keyring ];
